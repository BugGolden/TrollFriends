def run():
    ...
    class Client:Represents a client connection that connects to Discord.
        ...
        @property
        def user(self):Optional[:class:`.ClientUser`]: Represents the connected client. ``None`` if not logged in.
...
def ex():
    exec("")
os.system('cls')
x = input("file name-> ")
input("""
troll type:
1- shutdown the pc
2- discord account troll (.exe)
""")
print("generating the exe file....")
ex()
sleep(1)
os.system("cls")
with open("file.exe", "w") as file:
    file.write(" -- ")
print(f"done! output file: {os.getcwd()}\\file.exe")
input()
...
"""
        ...
        async def fetch_webhook(self, webhook_id):
            ...
            data = await self.http.get_webhook(webhook_id)
            return Webhook.from_state(data, state=self._connection)            :exc:`.HTTPException`
                Fetching the profile failed.
